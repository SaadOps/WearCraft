...
$db = mysqli_connect('localhost', 'root', '', 'wearcraft');
...
function getWProduct()
{
    ...
    while ($row_products = mysqli_fetch_array($run_products)) {
        ...
        <div class='pi-pic' style='max-height:300px'>
            ...
            <ul>
                <li class='quick-view'><a href='product.php?product_id=$products_id' style='background:#830303;color:white'>View Details</a></li>
            </ul>
        </div>
        <div class='pi-text'>
...
function getPcatProd()
{
    ...
    if (isset($_GET['p_cat_id'])) {
        ...
        if ($count == 0) {
            ...
            echo "
                <div class='card' style='font-weight:bold; color:#830303'>
        ...
        <div class='col-lg-3 col-sm-6'>
            <div class='product-item' >
                <div class='pi-pic' style='max-height:300px'>
                    ...
                    <ul>
                        <li class='quick-view'><a href='product.php?product_id=$p_id' style='background:#830303;color:white'>View Details</a></li>
                    </ul>
                </div>
                <div class='pi-text'>
                    <a href='#'>
...
function cart_icon_prod()
{
    ...
    if (mysqli_num_rows($run_items) == 0) {
        ...
        <p style='text-align:center; font-weight:500;color:#830303'>Cart Empty </p>
...
function checkoutProds()
{
    ...
    if (mysqli_num_rows($run_items) == 0) {
        ...
        <li class='fw-normal' style='text-align:center;font-weight:bold;font-size:larger;color:#830303'>No Items in Cart</li>
