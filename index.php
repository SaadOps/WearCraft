...
<section class="hero-section">
    <div class="hero-items owl-carousel">
        ...
        <?php
        // First Slider
        $get_slides = "SELECT * FROM slider WHERE slide_id = 1";
        ...
        // Second Slider
        $get_slides = "SELECT * FROM slider WHERE slide_id = 2";
        $run_slider = mysqli_query($con, $get_slides);
        ...
        while ($row_slides = mysqli_fetch_array($run_slider)) {
            ...
            <div class='single-hero-items set-bg' data-setbg='img/$slide_image'>
             ...
             // Third Slider
            $get_slides = "SELECT * FROM slider WHERE slide_id = 3";
             $run_slider = mysqli_query($con, $get_slides);
                 ...
                 <div class='single-hero-items set-bg' data-setbg='img/$slide_image'>
                     <div class='container'>
                         <div class='row'>
                             <div class='col-lg-5'>
                                 <h1 style='color: white;'>$slide_heading</h1>
                                 <p style='color: #191919;'>$slide_text</p>
                                 <a href='./customize/customize.php' class='primary-btn'>Customize Now</a>
                             </div>
                         </div>
                     </div>
                 </div>";
...
if (isset($_GET['stat']) && !isset($_SESSION['welcome_popup_shown'])) {
    echo "
        <script>
            bootbox.alert({
