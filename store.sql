create database if not exists wearcraft;
use wearcraft;
...
INSERT INTO `customer` (`customer_id`, `customer_name`, `customer_email`, `customer_pass`, `customer_address`, `customer_contact`,`customer_ip`) VALUES
(1, 'Saad', 'saad7teen@gmail.com', '123', 'Mumbai', '1234567890', 0);
...
(1, 'Slide 1', 'slide_1.jpg', 'Winter Sale', 'Walk in for the Fashion, Stay in for the Style.'),
(2, 'Slide 2', 'slide_2.jpg', 'Black friday', 'Simply Eveything You Want.'),
(3, 'Slide 3', 'slide_3.png', 'WearCraft', 'We Craft Your Vision.');
